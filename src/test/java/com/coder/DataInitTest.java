...
public class DataInitTest {
    ...
    void initPermission() {
        ...
        // 一级菜单 (permissionType=0)
        permissionMapper.insert(new Permission().setPermissionLable("系统管理").setPid(0).setParentLabel("根目录")
                .setPermissionCode("system").setRoutePath("/system").setRouteName("System")
                .setRouteUrl("/system").setPermissionType(0).setIcon("el-icon-setting")
                .setOrderNum(1).setCreateTime(now).setUpdateTime(now).setRemark("系统管理模块").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("车辆管理").setPid(0).setParentLabel("根目录")
                .setPermissionCode("auto").setRoutePath("/auto").setRouteName("Auto")
                .setRouteUrl("/auto").setPermissionType(0).setIcon("el-icon-truck")
                .setOrderNum(2).setCreateTime(now).setUpdateTime(now).setRemark("车辆管理模块").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("客户管理").setPid(0).setParentLabel("根目录")
                .setPermissionCode("customer").setRoutePath("/customer").setRouteName("Customer")
                .setRouteUrl("/customer").setPermissionType(0).setIcon("el-icon-user")
                .setOrderNum(3).setCreateTime(now).setUpdateTime(now).setRemark("客户管理模块").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("订单管理").setPid(0).setParentLabel("根目录")
                .setPermissionCode("order").setRoutePath("/order").setRouteName("Order")
                .setRouteUrl("/order").setPermissionType(0).setIcon("el-icon-s-order")
                .setOrderNum(4).setCreateTime(now).setUpdateTime(now).setRemark("订单管理模块").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("报表统计").setPid(0).setParentLabel("根目录")
                .setPermissionCode("report").setRoutePath("/report").setRouteName("Report")
                .setRouteUrl("/report").setPermissionType(0).setIcon("el-icon-data-analysis")
                .setOrderNum(5).setCreateTime(now).setUpdateTime(now).setRemark("报表统计模块").setDeleted(false));

        // 系统管理子菜单 (permissionType=1, pid=1)
        permissionMapper.insert(new Permission().setPermissionLable("用户管理").setPid(1).setParentLabel("系统管理")
                .setPermissionCode("system:user").setRoutePath("/system/user").setRouteName("SystemUser")
                .setRouteUrl("/system/user").setPermissionType(1).setIcon("el-icon-user-solid")
                .setOrderNum(1).setCreateTime(now).setUpdateTime(now).setRemark("用户管理页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("角色管理").setPid(1).setParentLabel("系统管理")
                .setPermissionCode("system:role").setRoutePath("/system/role").setRouteName("SystemRole")
                .setRouteUrl("/system/role").setPermissionType(1).setIcon("el-icon-s-custom")
                .setOrderNum(2).setCreateTime(now).setUpdateTime(now).setRemark("角色管理页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("权限管理").setPid(1).setParentLabel("系统管理")
                .setPermissionCode("system:permission").setRoutePath("/system/permission").setRouteName("SystemPermission")
                .setRouteUrl("/system/permission").setPermissionType(1).setIcon("el-icon-lock")
                .setOrderNum(3).setCreateTime(now).setUpdateTime(now).setRemark("权限管理页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("部门管理").setPid(1).setParentLabel("系统管理")
                .setPermissionCode("system:dept").setRoutePath("/system/dept").setRouteName("SystemDept")
                .setRouteUrl("/system/dept").setPermissionType(1).setIcon("el-icon-office-building")
                .setOrderNum(4).setCreateTime(now).setUpdateTime(now).setRemark("部门管理页面").setDeleted(false));

        // 车辆管理子菜单 (permissionType=1, pid=2)
        permissionMapper.insert(new Permission().setPermissionLable("厂商管理").setPid(2).setParentLabel("车辆管理")
                .setPermissionCode("auto:maker").setRoutePath("/auto/maker").setRouteName("AutoMaker")
                .setRouteUrl("/auto/maker").setPermissionType(1).setIcon("el-icon-files")
                .setOrderNum(1).setCreateTime(now).setUpdateTime(now).setRemark("厂商管理页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("品牌管理").setPid(2).setParentLabel("车辆管理")
                .setPermissionCode("auto:brand").setRoutePath("/auto/brand").setRouteName("AutoBrand")
                .setRouteUrl("/auto/brand").setPermissionType(1).setIcon("el-icon-collection-tag")
                .setOrderNum(2).setCreateTime(now).setUpdateTime(now).setRemark("品牌管理页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("车辆信息").setPid(2).setParentLabel("车辆管理")
                .setPermissionCode("auto:info").setRoutePath("/auto/info").setRouteName("AutoInfo")
                .setRouteUrl("/auto/info").setPermissionType(1).setIcon("el-icon-truck")
                .setOrderNum(3).setCreateTime(now).setUpdateTime(now).setRemark("车辆信息页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("维保记录").setPid(2).setParentLabel("车辆管理")
                .setPermissionCode("auto:maintain").setRoutePath("/auto/maintain").setRouteName("AutoMaintain")
                .setRouteUrl("/auto/maintain").setPermissionType(1).setIcon("el-icon-set-up")
                .setOrderNum(4).setCreateTime(now).setUpdateTime(now).setRemark("维保记录页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("违章记录").setPid(2).setParentLabel("车辆管理")
                .setPermissionCode("auto:violation").setRoutePath("/auto/violation").setRouteName("AutoViolation")
                .setRouteUrl("/auto/violation").setPermissionType(1).setIcon("el-icon-warning")
                .setOrderNum(5).setCreateTime(now).setUpdateTime(now).setRemark("违章记录页面").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("出租类型").setPid(2).setParentLabel("车辆管理")
                .setPermissionCode("auto:rentalType").setRoutePath("/auto/rentalType").setRouteName("AutoRentalType")
                .setRouteUrl("/auto/rentalType").setPermissionType(1).setIcon("el-icon-discount")
                .setOrderNum(6).setCreateTime(now).setUpdateTime(now).setRemark("出租类型页面").setDeleted(false));

        // 按钮权限 (permissionType=2)
        permissionMapper.insert(new Permission().setPermissionLable("新增用户").setPid(6).setParentLabel("用户管理")
                .setPermissionCode("system:user:add").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(1).setCreateTime(now).setUpdateTime(now).setRemark("新增用户按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("编辑用户").setPid(6).setParentLabel("用户管理")
                .setPermissionCode("system:user:edit").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(2).setCreateTime(now).setUpdateTime(now).setRemark("编辑用户按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("删除用户").setPid(6).setParentLabel("用户管理")
                .setPermissionCode("system:user:delete").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(3).setCreateTime(now).setUpdateTime(now).setRemark("删除用户按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("新增车辆").setPid(12).setParentLabel("车辆信息")
                .setPermissionCode("auto:info:add").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(1).setCreateTime(now).setUpdateTime(now).setRemark("新增车辆按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("编辑车辆").setPid(12).setParentLabel("车辆信息")
                .setPermissionCode("auto:info:edit").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(2).setCreateTime(now).setUpdateTime(now).setRemark("编辑车辆按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("删除车辆").setPid(12).setParentLabel("车辆信息")
                .setPermissionCode("auto:info:delete").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(3).setCreateTime(now).setUpdateTime(now).setRemark("删除车辆按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("创建订单").setPid(0).setParentLabel("根目录")
                .setPermissionCode("system:order:add").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(99).setCreateTime(now).setUpdateTime(now).setRemark("创建订单按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("编辑订单").setPid(0).setParentLabel("根目录")
                .setPermissionCode("system:order:edit").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(99).setCreateTime(now).setUpdateTime(now).setRemark("编辑订单按钮").setDeleted(false));
        permissionMapper.insert(new Permission().setPermissionLable("删除订单").setPid(0).setParentLabel("根目录")
                .setPermissionCode("system:order:delete").setRoutePath("").setRouteName("")
                .setRouteUrl("").setPermissionType(2).setIcon("")
                .setOrderNum(99).setCreateTime(now).setUpdateTime(now).setRemark("删除订单按钮").setDeleted(false));
        System.out.println("权限数据初始化完成，共23条");
    }
