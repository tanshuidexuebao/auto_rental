...
/*    public static void main(String[] args) {
        ...
        System.out.println("加密后密码: " + encodedPassword1);
        String encodedPassword2 = encoder.encode(password);
        System.out.println("加密后密码: " + encodedPassword2);
        String encodedPassword3 = encoder.encode(password);
        System.out.println("加密后密码: " + encodedPassword3);
        String encodedPassword4 = encoder.encode(password);
        System.out.println("加密后密码: " + encodedPassword4);
